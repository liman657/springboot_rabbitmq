...
import com.learn.springbootrabbitmqlearn.config.MailProperties;
...
//        mimeMessage.addRecipients(Message.RecipientType.TO, addresses);
        ...
        //TODO：只发送一个收件人
        mimeMessage.addRecipients(Message.RecipientType.TO, "657271181@qq.com");
        mimeMessage.addRecipients(Message.RecipientType.CC, "liman65727@sina.com.cn");//抄送给
